    ...
    <nav class="navbar navbar-expand-md p-2 bottom-divider" style="position: sticky;">
        ...
        <div class="collapse navbar-collapse ml-5 mr-3 pl-5" id="MyNavHorizontal">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item <?php echo (basename($_SERVER['PHP_SELF']) == "StudentList.php") ? "active" : "" ?>">
                    <a class="nav-link" href="../Admin/StudentList.php"><span style="color: #224172;">Student List</span></a>
                </li>
                <!-- <li class="left-divider ml-2 mr-2"></li> -->
                <li class="nav-item <?php echo (basename($_SERVER['PHP_SELF']) == "StaffList.php") ? "active" : "" ?>">
                    <a class="nav-link" href="../Admin/StaffList.php"><span style="color: #224172;">Staff List</span></a>
                </li>
                <!-- <li class="left-divider ml-2 mr-2"></li> -->
                <!-- <li class="nav-item">
